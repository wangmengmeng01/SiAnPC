<template>
  <div class="app-container recharge-history">
    ...
    >
      <add-system-recharge slot="table-header" :getTablePageListParams="getTablePageListParams" @success="updateTablePageListParams({})">系统充值</add-system-recharge>
...
import addSystemRecharge from './add-system-recharge'
  ...
  data() {
    return {
      ...
      tableCols: [
        ...
        { prop: 'diamondAmount', label: '充值钻石数量' },
